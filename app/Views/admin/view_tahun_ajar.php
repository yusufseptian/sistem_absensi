                    ...
                    foreach ($Tahun_ajar as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-xs btn-flat btn-danger" data-toggle="modal" data-target="#delete<?= $value['th_id'] ?>">
...
<?php foreach ($Tahun_ajar as $key => $value) { ?>
    <div class="modal fade" id="edit<?= $value['th_id'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?= form_open('Tahun_ajar/editData/' . $value['th_id']) ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Tahun Ajaran</label>
...
<!-- Modal Delete -->
<?php foreach ($Tahun_ajar as $key => $value) { ?>
    <div class="modal fade" id="delete<?= $value['th_id'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda ingin menghapus <b><?= $value['th_ajaran'] ?></b>?
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Tutup</button>
                    <a href="<?= base_url('Tahun_ajar/deleteData/' . $value['th_id']) ?>" class="btn btn-danger btn-sm">Hapus</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
